...
frame.setVisible(true);
		...
		frame.setTitle("BinaryConverter");
...
JLabel label = new JLabel("ASCII:");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonPressed == convertButton) {
			...
			String out = binaryToAscii(input);
			asciiResult.setText(out);
			String out2 = binaryToInt(input);
			decimalResult.setText(out2);
			String out3 = binaryToHex(input);
			hexResult.setText(out3);
		}
